...
1. The carbon fiber strands act as a matrix to strengthen or toughen the silicone rubber, increasing the hardness significantly. The same technique but done with typical polymer fibers instead, is used to strengthen rubber.
